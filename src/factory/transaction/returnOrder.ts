...
export type IStartParams = TransactionFactory.IStartParams<cinerino.transactionType.ReturnOrder, IAgent, undefined, IObject>;
...
export interface ISearchConditions extends TransactionFactory.ISearchConditions<cinerino.transactionType.ReturnOrder> {
    object?: {
        order?: {
            /**
             * 返品対象注文番号
